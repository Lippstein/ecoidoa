...
@section('content')
    ...
    <div class="container">
        ...
        <div class="d-flex justify-content-end gap-2 mb-3">
            <a href="{{ route('tesauro_list.show', ['niche_filter' => request('niche_filter'), 'bt_filter' => request('bt_filter')]) }}"
        ...
        @php
            ...
            $definition = '';
            $id_niche = request('niche_filter', $term->id_niche ?? '');
            $language = 'pt_BR';
                ...
                <div class="table-responsive">
                    <table class="table table-sm table-striped mb-0">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="3" class="text-center text-muted">Nenhuma questão encontrada.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
        ...
        <div class="accordion accordion-flush" id="accordionFlushExample">
            <div class="accordion-item">
                ...
                <div id="flush-collapseOne" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <form id="questionFormSingle" method="POST" action="{{ route('term_questions.create') }}"
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <form id="questionFormMultiple" method="POST" action="{{ route('term_questions.create') }}"
                            class="m-4 question-form" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <input type="hidden" name="niche_filter" value="{{ request('niche_filter') }}">
                ...
                <div id="flush-collapseThree" class="accordion-collapse collapse"
                    ...
                    <div class="accordion-body">
                        <form id="questionFormAfirmacaoIncompleta" method="POST"
                            action="{{ route('term_questions.create') }}" class="m-4 question-form"
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <form id="questionFormFocoNegativo" method="POST" action="{{ route('term_questions.create') }}"
                            class="m-4 question-form" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <input type="hidden" name="niche_filter" value="{{ request('niche_filter') }}">
            ...
            <div class="accordion-item">
                ...
                <div id="flush-collapseFive" class="accordion-collapse collapse" data-bs-parent="#accordionFlushExample">
                    <div class="accordion-body">
                        <form id="questionFormAssercaoRazao" method="POST" action="{{ route('term_questions.create') }}"
                            class="m-4 question-form" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                            <input type="hidden" name="niche_filter" value="{{ request('niche_filter') }}">
